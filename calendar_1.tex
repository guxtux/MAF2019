...
\documentclass[14pt]{article} % Can also use 9pt or 11pt for a smaller or larger overall font size
...
\day{Tema}{Presentación del curso de MAF.
\eventskip Resumen de cómo se trabajará y a dónde queremos llevarlos al final del curso.} % 1 - Example of content: first argument is the heading, then the content of the day
