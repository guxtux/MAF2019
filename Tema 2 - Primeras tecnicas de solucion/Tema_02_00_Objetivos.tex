...
\bigskip
\pause
Como primera técnica de solución, ocuparemos \textocolor{ao}{la técnica de separación de variables}.
\end{frame}
% \begin{frame}
...
\begin{frame}
\frametitle{Soluciones obtenidas con la técnica}
El sistema de EDO obtenido se resuelve de una manera mucho más sencilla, tal y como lo vieron en su curso de \textocolor{burgundy}{Ecuaciones diferenciales I} en la carrera.
\end{frame}
\begin{frame}
\frametitle{Etapas de trabajo}
En todo momento esperamos que ocupen la siguiente estrategia de trabajo:
\setbeamercolor{item projected}{bg=aqua,fg=bole}
...
En este tema como se habrán dado cuenta, será necesario apoyarse \enquote{\textocolor{red}{fuertemente}} en las técnicas de solución de las EDO.
\\
\bigskip
\pause
Así como del manejo de series de potencias que se revisa en el curso de \textocolor{bulgarianrose}{Álgebra lineal}.
\end{frame}
% \begin{frame}
