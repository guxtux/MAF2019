...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
    \usebeamerfont{date in head/foot} {T2 - Primera presentación} \hspace*{2em}
...
\end{enumerate}
\pause
pueden describirse en general mediante \textocolor{byzantine}{ecuaciones diferenciales parciales (EDP)}.
\end{frame}
\begin{frame}
\frametitle{Uso de las EDP}
...
\bigskip
\pause
La variable $u$ (que diferenciamos) se llama \textocolor{ao}{variable dependiente}, \pause mientras que aquellas con respecto a las que diferenciamos se llaman \textocolor{bole}{variables independientes}.
\end{frame}
\begin{frame}
\frametitle{Variables en las EDP}
...
\bigskip
\pause
Los métodos \textocolor{debianred}{más importantes son los que convierten las EDP en EDO}, ya que simplifican el manejo y su solución.
\end{frame}
\begin{frame}
...
Es por ello que el título de este Tema 2 es \enquote{\textocolor{red}{Primeras técnicas de solución}}, ya que abordaremos tres estrategias para resolver EDP.
\end{frame}
\begin{frame}
\frametitle{Primeras técnicas}
...
Las ecuaciones \textocolor{burgundy}{parabólicas} describen por ejemplo el flujo de calor y procesos de difusión, además satisfacen la propiedad $B^{2} - 4 \, A \, C = 0$.
\end{frame}
\begin{frame}
\frametitle{EDP hiperbólicas}
Las ecuaciones \textocolor{cadmiumgreen}{hiperbólicas} describen sistemas que vibran así como el movimiento de las ondas, satistacen la propiedad $B^{2} - 4 \, A \, C > 0$.
\end{frame}
\begin{frame}
\frametitle{EDP elìpticas}
Las ecuaciones \textocolor{carmine}{elípticas} describe fenómenos estacionarios y satisfacen la propiedad $B^{2} - 4 \, A \, C < 0$.
\end{frame}
\begin{frame}
\frametitle{Ejemplos}
Como ejemplo veamos:
