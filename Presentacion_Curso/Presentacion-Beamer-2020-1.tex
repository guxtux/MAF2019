...
\subtitle{Semestre 2020-1}
\author[]{Gustavo Contreras Mayén \& Abraham Lima Buendía}
...
\end{enumerate}
\end{frame}
\subsection{Tema 3 - Bases completas y ortogonales.}
\begin{frame}
...
\end{enumerate}
\end{frame}
\subsection{Tema 6 - Transformadas integrales.}
\begin{frame}
