...
\vskip 1cm
\RBox{
Jaime Iván Carlos Félix  \\
\href{mailto:ivancf95@ciencias.unam.mx}{ivancf95@ciencias.unam.mx}
}
\end{center}
\end{frame}
...
\href{https://www.fciencias.unam.mx/sites/default/files/temario/610.pdf}{\underline{aquí}}, y contiene los siguientes objetivos:
\end{frame}
\begin{frame}
\frametitle{Objetivos del curso}
...
\begin{enumerate}[<+->]
\item Reconocerá las ideas básicas del análisis de ecuaciones que involucran a las funciones de varias variables.
...
Las sesiones se llevarán a cabo los días establecidos: \textbf{martes y jueves} de 17:30 am a las 20:00 pm en el aula O-131.
\end{frame}
...
\item Ecs. Dif. de tipo Sturm-Liouville.
...
\begin{enumerate}[<+->]
\item \textcolor{blue}{Parte radial}: ED asociada de Laguerre y la ED ordinaria de Laguerre.
\item \textcolor{blue}{Parte angular}: que consta de:
\begin{enumerate}
  \item[2.1] Armónicos esféricos.
  \item[2.2] Teorema de adición.
  \item[2.3] ED asociada de Legendre y la ED ordinaria de Legendre.
\end{enumerate}
\end{enumerate}
\end{frame}
...
\begin{itemize}[<+->]
\item Lunes 17 de agosto de 2026. Inicio del semestre 2027-1.
\item \textocolor{byzantium}{Martes 18 de agosto. Primera clase del curso.}
\item Martes 15 de septiembre. \underline{Día feriado}.
\item Lunes 12 al viernes 16 de octubre. \underline{Semana de receso}.
\item Viernes 11 diciembre. Termina el semestre 2027-1.
\end{itemize}
\end{frame}
\begin{frame}
\frametitle{Fechas importantes}
\begin{itemize}[<+->]
\item \textocolor{ao}{Del lunes 14 de diciembre de 2026 al viernes 1 de enero de 2027.} \underline{Período vacacional}.
\item \textocolor{red}{Del lunes 4 al viernes 8 de enero de 2027.} \underline{1a. semana de exámenes finales}.
\item \textocolor{red}{Del lunes 11 al viernes 15 de enero de 2027.} \underline{2a. semana de exámenes finales}.
\end{itemize}
\end{frame}
