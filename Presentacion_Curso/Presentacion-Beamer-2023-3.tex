...
\section{Temario}
\frame[allowframebreaks]{\frametitle{Contenido}\small\tableofcontents[currentsection, hideothersubsections]}
...
\setbeamercolor{item projected}{bg=blue(pigment),fg=white}
\setbeamertemplate{enumerate items}{%
\usebeamercolor[bg]{item projected}%
\raisebox{1.5pt}{\colorbox{bg}{\color{fg}\footnotesize\insertenumlabel}}%
}
...
\setbeamercolor{item projected}{bg=ceruleanblue,fg=champagne}
\setbeamertemplate{enumerate items}{%
\usebeamercolor[bg]{item projected}%
\raisebox{1.5pt}{\colorbox{bg}{\color{fg}\footnotesize\insertenumlabel}}%
}
