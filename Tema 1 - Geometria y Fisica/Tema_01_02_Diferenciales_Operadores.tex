...
\begin{frame}
\frametitle{Ejercicios a cuenta}
Para  cada uno de los siguientes sistemas coordenados calcula:
...
\begin{enumerate}[<+->]
\item los factores de escala $h_{i}$
\item el vector $\dd{\vb{l}}$
\item el elemento $ds^{2}$
\item el elemento de superficie $\dd{\vb{S}}$
\item el elemento de volumen $\dd{V}$
\item los vectores base $\vu{e}_{i}$
\end{enumerate}
\end{frame}
\begin{frame}
\frametitle{Ejercicios a cuenta}
