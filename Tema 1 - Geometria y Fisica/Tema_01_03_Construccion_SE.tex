...
\item Los diferenciales de línea, superficie y volumen.
...
\begin{eqnarray*}
\begin{aligned}
\dfrac{y^{2}}{\sin^{2} v} &= \dfrac{a^{2} \, \sinh^{2} u \, \sin^{2} v}{\sin^{2} v} = \pause a^{2} \, \sinh^{2} u  \\[0.5em] \pause
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Imagenes/CoordenadasElipticas_uv_constantes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Imagenes/sistema_06_Cilindricas_Elipticas.png}
...
&+ \dfrac{\vu{e}_{v}}{h_{z} h_{u}} \left[ \displaystyle \pdv{z} \left( B_{u} \, h_{u} \right) - \pdv{u} \left( B_{z} \, h_{z} \right) \right] + \\[0.5em]
