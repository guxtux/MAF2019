...
\draw [->] (O) -- (0.9, -0.3, 0) node [at end, right] {$\Delta \vb{s}_{j}$};

\draw (0, -0.4, 0) -- (0.9, -0.3, 0);
% \draw [->] (O) -- (1, 0.25, 0) node [at end, right] {$\displaystyle \nabla{v}$};

\draw [->] (O) -- (0.1, 1, 0) node [at end, above] {$\Delta \vb{s}_{i} \cp \Delta \vb{s}_{j}$};
% \draw [->] (O) -- (0.2, 0.7, 0) node [at end, right] {$\displaystyle \nabla{w}$};

\draw [->] (O) -- (-0.1, 0.6, 1) node [at end, left]  {$\Delta \vb{s}_{i}$};
\draw (-0.1, 0.6, 1) -- (0, -0.4, 0);
% \draw [->] (O) -- (0.5, 0, 1.1) node [at end, right] {$\displaystyle \nabla{u}$};

\draw [draw=blue, -Circle] (O) to [bend left=8] coordinate [pos=0.875] (q2n) (1, -0.25, 0) coordinate (q2) node [right] {Curva $q_{j}$};

\draw [draw=blue, -Circle] (O) to [bend right=8] coordinate [pos=0.875] (q3n) (0, 1, 0.5) coordinate (q3) node [left] {Curva $q_{k}$};

\draw [draw=blue, -Circle] (O) to [bend right=8] coordinate [pos=0.875] (q1n) (0.25, 0, 1.3) coordinate (q1) node [right] {Curva $q_{i}$};
