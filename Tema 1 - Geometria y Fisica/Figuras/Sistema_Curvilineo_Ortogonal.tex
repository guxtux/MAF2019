...
\draw [->] (O) -- (1,0,0) node [at end, right] {$\vu{e}_{1}$};
\draw [->] (O) -- (0,1,0) node [at end, above] {$\vu{e}_{2}$};
\draw [->] (O) -- (0,0,1) node [at end, left]  {$\vu{e}_{3}$};

\draw [draw=blue, -Circle] (O) to [bend left=8] 
  coordinate [pos=7/8] (q2n) 
  (1,-1/4,0) coordinate (q2) node [right] {$u_{1}$};
\draw [draw=blue, -Circle] (O) to [bend right=8] 
  coordinate [pos=7/8] (q3n) 
  (0,1,1/2) coordinate (q3) node [left] {$u_{2}$};
\draw [draw=blue, -Circle] (O) to [bend right=8] 
  coordinate [pos=7/8] (q1n) 
  (1/4,0,1) coordinate (q1) node [right] {$u_{3}$};
...
\node at (0,1/2,1/2) {$u_1=\mbox{cte.}$};
\node at (1/2,0,1/3) {$u_2=\mbox{cte.}$};
\node at (1/3,1/3,0) {$u_3=\mbox{cte.}$};
\end{tikzpicture}
\end{document}