...
\title{\large{Sistema de coordenadas curvilíneas ortogonales}}
...
En el espacio euclidiano tridimensional las coordenadas cartesianas se definen en términos de tres familias de planos perpendiculares 
\begin{align*}
...
\begin{frame}
\frametitle{Coordenadas esféricas}
La conexión entre coordenadas cartesianas y esféricas tiene la forma:
\begin{align*}
...
\begin{figure}[h!]
   \centering
   \includegraphics[scale=0.8]{Figuras/Sistema_Curvilineo_Ortogonal}
...
En el curso nos enfocaremos en el estudio de este tipo de sistemas, los sistemas coordenados no ortogonales no los revisaremos.
\end{frame}
\begin{frame}
\frametitle{Características del sistema coordenado}
\setbeamercolor{item projected}{bg=blue!70!black,fg=yellow}
...
\begin{align}
\vu{e}_{i} = \dfrac{1}{h_{i}} \left( \vu{i} \, \pdv{x}{u_{i}} + \vu{j} \, \pdv{y}{u_{i}} + \vu{i} \, \pdv{z}{u_{i}} \right)
