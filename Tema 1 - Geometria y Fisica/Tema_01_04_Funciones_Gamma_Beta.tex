...
\begin{enumerate}[<+->]
  ...
  \item $\Gamma (x) = (x - 1) \, \Gamma(x - 1), \hspace{1cm} x \neq 0, -1, -2, \ldots$ 
  \item $\Gamma (-x) = \dfrac{\Gamma (1- x)}{-x}, \hspace{1cm} x \neq 0, 1, 2, \ldots$
  \item $\Gamma (x) \, \Gamma (1 - x) = \dfrac{\pi}{\sin x \, \pi}, \hspace{0.5cm}  x \neq 0, \pm 1, \pm 2, \pm 3, \ldots$
% \end{aligned}
% \end{eqnarray*}
\seti
\end{enumerate}
...
\begin{enumerate}[<+->]
  \setlength{\itemsep}{1em}
  \conti
  \item $n! = \left( \dfrac{n}{e} \right)^{n} \, \sqrt{2 \, \pi \, n} + h$
  
  con $n = 1, 2, 3, \ldots, \hspace{0.5cm} 0 < \dfrac{h}{n!} < \dfrac{1}{12 \, n}$
  \item $\Gamma \left(n + \dfrac{1}{2} \right) = \dfrac{1 \cdot 3 \cdot 5 \ldots (2 \, n - 1)\sqrt{\pi}}{2^{n}}$
...
\begin{enumerate}[<+->]
  \conti
  \item $\scaleint{6ex}_{\bs 0}^{\infty} t^{a} \, e^{-b \, t^{c}} \dd{t} = \dfrac{\Gamma \left(\dfrac{a + 1}{c} \right)}{c \, b^{(a+1)/c}},$

  \vspace{0.5cm}
  con  $a > -1, \hspace{0.5cm} b > 0, \hspace{0.5cm} c > 0$
% \end{aligned}
% \end{eqnarray*}
\end{enumerate}
}
...
\begin{eqnarray}
\begin{aligned}[b]
&\dv{\ln (z!)}{z} \equiv \psi(z + 1) = \\[0.5em] \pause
...
\begin{eqnarray}
\begin{aligned}[b]
\psi (z + 1) &= - \gamma - \nsum_{n=1}^{\infty} \left( \dfrac{1}{z + n} - \dfrac{1}{n} \right) = \\[0.5em] \pause
&= -\gamma + \nsum_{n=1}^{\infty} \dfrac{z}{n (n + z)}
\end{aligned}
...
\begin{eqnarray}
\begin{aligned}
&\ntilde{\psi}{m} (z + 1) \equiv \dv[m+1]{z} \ln(z!) = \\[0.5em] \pause
...
\begin{enumerate}[<+->]
  \setlength{\itemsep}{1em}
  \item $B (x, y) = B (y, x)$ % \\[1em]
  \item $B (x, 2 - x) = \dfrac{\pi}{\sin x \, \pi}, \hspace{0.75cm} 0 < x < 1$
\end{enumerate}
% \end{align*}
\end{frame}
...
\pause
\begin{eqnarray*}
K = \dfrac{m \, v^{2}}{2} = \pause \dfrac{1}{2} \, \dfrac{W}{g} \left( r \, \dv{\theta}{t} \right)^{2}
\end{eqnarray*}
