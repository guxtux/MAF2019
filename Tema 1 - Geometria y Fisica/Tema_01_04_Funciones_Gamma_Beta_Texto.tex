...
\begin{align*}
\Gamma (-0.3) &= \dfrac{1}{-0.3} \, \Gamma (-0.3 + 1) \\[0.5em]
\Gamma (-0.3) &= \dfrac{1}{-0.3} \, \Gamma (0.7) \\[0.5em]
...
\begin{align*}
\Gamma (-1.3) &= \dfrac{1}{(-1.3)} \, \Gamma (-1.3 + 1) = \\[0.5em]
\Gamma (-1.3) &= \dfrac{1}{(-1.3)} \, \Gamma (-0.3) = \\[0.5em]
\Gamma (-1.3) &= \dfrac{1}{(-1.3)(-0.3)} \, \Gamma (0.7) = \\[0.5em]
...
Entonces tenemos que:
\begin{align*}
\Gamma \left( \dfrac{1}{2} \right) = \int_{0}^{\infty} \, \dfrac{1}{y} \, e^{-y^{2}} \, 2 \, y \dd{y} = 2 \int_{0}^{\infty} \, e^{-y^{2}} \dd{y}
\end{align*}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics{Imagenes/pendulo_simple.png}
