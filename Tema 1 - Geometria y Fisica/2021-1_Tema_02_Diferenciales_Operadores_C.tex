...
\end{figure}
Consideraremos el flujo total como la suma de los flujos a través de cada pareja de superficies. Como primer paso, analizamos el flujo sobre las caras $\dd{\vb{S}_{1}}$:
\par
