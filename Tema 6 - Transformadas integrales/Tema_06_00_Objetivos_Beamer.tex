...
\begin{figure}
    \centering
    \only<1>{\includegraphics[scale=1]{Imagenes/Trazo_Senal_01.eps} \\Señal continua no periódica}
    \only<2>{\includegraphics[scale=1]{Imagenes/Trazo_Senal_02.eps} \\Señal continua periódica}
    \only<3>{\includegraphics[scale=1]{Imagenes/Trazo_Senal_03.eps} \\Señal discreta no periódica}
    \only<4>{\includegraphics[scale=0.78]{Imagenes/Trazo_Senal_04.eps} \\Señal discreta periódica}
\end{figure}
\end{frame}
\begin{frame}
