...
\begin{frame}
\frametitle{Ejercicio 1}
Un cilindro macizo está limitado por las superficies $r = 1$, $z = 0$ y $z = b$. La primera superficie está aislada, la segunda se conserva a la temperatura cero, y la última a las temperaturas $f (r)$.
\\
\bigskip
¿Cuál es la distribución de temperaturas $u (r, z)$ en el cilindro.
\end{frame}
\begin{frame}
\frametitle{Ejercicio 2}
Cuando $f (r) = A (0 < r < 1)$ en el problema anterior, demuestra que:
\begin{align*}
  u (r, z) = \dfrac{A \, z}{b}
\end{align*}
\end{frame}
