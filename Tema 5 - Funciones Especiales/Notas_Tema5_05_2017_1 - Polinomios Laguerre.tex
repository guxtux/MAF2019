...
% \end{figure}
% \newpage
%Referencia: Sepúlveda. 8.6 Polinomios de Laguerre
...
\end{align*}
Por tanto: $k = 0$ y de la segunda ecuación de índices
...
\par
%Referencia: Eisberg - Física moderna. Cap. 10 Átomos con un electrón
% 10.3 Separación y solución de la ec. de movimiento relativo.
...
\begin{table}
\centering
%\captionof{table}{Valores posibles de $\ell$ y $m$ para $n = 1, 2, 3$}
...
funciones propias degeneradas para cada $n$ & $1$ & \multicolumn{2}{c |}{$4$} & \multicolumn{3}{c |}{$9$} \\ \hline
\end{tabular}
...
\end{enumerate}
\newpage
%Referencia: Arfken. Example 13.2.1 The hydrogen atom
\section{El átomo de hidrógeno.}
...
\end{align}
la ecuación (\ref{eq:ecuacion_13_085}) se transforma en
\begin{align}
...
\end{align*}
Por lo que la función de onda normalizada para el átomo de hidrógeno está dada por
\begin{align}
\begin{aligned}
