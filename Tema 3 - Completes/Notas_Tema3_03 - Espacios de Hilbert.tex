...
por lo que
\begin{equation}
\abs{ \langle \Delta \hat{A} \, \Delta \hat{B} \rangle}^{2} = \dfrac{1}{4} \abs{\langle [ \Delta \hat{A}, \Delta \hat{B} ] \rangle}^{2} + \dfrac{1}{4} \abs{ \langle \left\{ \Delta \hat{A}, \Delta \hat{B}] \right\} \rangle}^{2}
...
\begin{equation}
\langle (\Delta \hat{A})^{2} \rangle \, \langle (\Delta \hat{B})^{2} \rangle \geq \dfrac{1}{4} \abs{\langle [ \Delta \hat{A}, \Delta \hat{B} ] \rangle}^{2}
\label{eq:ecuacion_02_105}
\end{equation}
que al tomar la raíz cuadrada, se puede reducir a
\begin{equation}
\hat{A} \, \hat{B}) \geq \dfrac{1}{2} \abs{\langle [ \Delta \hat{A}, \Delta \hat{B} ] \rangle}
