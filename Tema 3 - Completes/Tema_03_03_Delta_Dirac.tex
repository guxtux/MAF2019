...
\begin{frame}
\frametitle{Casos en la física}
Por ejemplo, en el curso de Mecánica Clásica se revisa el concepto de una magnitud física llamada \textocolor{ao}{impulso}, \pause la cual se introduce cuando se cambia el estado de movimiento de un cuerpo al aplicarle un \textocolor{debianred}{golpe repentino}. \pause El impulso se denota comúnmente con la letra $I$.
\end{frame}
\begin{frame}
