...
\setbeamercolor{section in foot}{bg=ginger, fg=white}
\setbeamercolor{subsection in foot}{bg=kellygreen, fg=white}
...
\setbeamercolor{item projected}{bg=midnightblue,fg=yellow}
