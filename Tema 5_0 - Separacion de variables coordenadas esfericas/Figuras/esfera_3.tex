...
\node [font= \Large] at (0,-1.75,1) {$V_{0}$};
\node [font= \Large] at (0,-1.75,-1) {$-V_{0}$};

\draw [thick ](0, 0, 1) -- (0, 0, 1.75) -- (0, 2, 2) -- (0, 2, 0.42);

\draw (0, 1.8, 0.4) -- (0, 2.2, 0.45);
\draw (0, 1.9, 0.3) -- (0, 2.1, 0.32);


\draw [thick ](0, 0, -1) -- (0, 0, -1.75) -- (0, 2, -1.5) -- (0, 2, 0.3);
