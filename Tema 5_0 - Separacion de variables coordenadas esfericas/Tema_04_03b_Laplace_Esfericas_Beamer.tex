...
Excepto por el uso de $u$ en lugar de $x$, \pause es completamente equivalente a la expansión del ejemplo que se encuentra en anexo que se deja en Moodle.
\\
\bigskip
\pause
...
El cálculo de los coeficientes es idéntico al del ejemplo anterior, y que podemos retomar en el anexo. 
\\
\bigskip
\pause
